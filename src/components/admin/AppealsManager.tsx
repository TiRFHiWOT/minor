...
import { CheckCircle, XCircle, MessageSquare, User, Calendar, FileText, AlertTriangle } from 'lucide-react';
...
export const AppealsManager = () => {
  ...
  const getContentTypeIcon = (contentType: string) => {
    return contentType === 'topic' ? <FileText className="h-4 w-4" /> : <MessageSquare className="h-4 w-4" />;
  };
  ...
  const reviewedAppeals = filterAppealsByStatus('approved').concat(filterAppealsByStatus('denied'));
      ...
      <Card className="p-6 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">There are no moderation appeals to review at this time.</p>
          </div>
        </div>
      </Card>
    );
            ...
            <Card className="p-6 text-center">
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">No pending appeals to review.</p>
                </div>
              </div>
            </Card>
          ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-3 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium capitalize">{appeal.content_type} Appeal</span>
                        ...
                        <div className="space-y-2">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">{appeal.appeal_reason}</p>
                          </div>
                          
                          {appeal.content_context && (
                            <div>
                              <span className="text-sm font-medium">Content Context:</span>
                          ...
                          {selectedAppeal && (
                            <div className="space-y-4">
                              <div className="space-y-2">
                                ...
                                <p className="text-sm capitalize">{selectedAppeal.content_type}</p>
                              </div>
                              ...
                              {selectedAppeal.content_context && (
                                <div className="space-y-2">
                                  ...
                                  <ScrollArea className="h-24 w-full rounded border p-3">
                                    <p className="text-sm">{selectedAppeal.content_context}</p>
                                  </ScrollArea>
                                </div>
                              )}
            ...
            <Card className="p-6 text-center">
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">No appeals have been reviewed yet.</p>
                </div>
              </div>
            </Card>
          ) : (
                      ...
                      <div className="space-y-2">
                        ...
                        {appeal.admin_response && (
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">{appeal.admin_response}</p>
                          </div>
                        )}
                      </div>
