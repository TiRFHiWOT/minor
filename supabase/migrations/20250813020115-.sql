-- Drop existing functions first, then recreate them to use topics and posts tables
...
DROP FUNCTION IF EXISTS public.get_enriched_topics(uuid, integer, integer, text);
DROP FUNCTION IF EXISTS public.get_enriched_topics_count(uuid);

-- Create get_enriched_posts function to query posts table
...
-- Create get_enriched_posts_count function to query posts table
...
-- Create get_enriched_topics function to query topics table
...
-- Create get_enriched_topics_count function to query topics table
