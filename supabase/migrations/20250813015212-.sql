-- Update the get_enriched_posts function to use posts table instead of forum_posts
...
-- Update the get_enriched_posts_count function to use posts table instead of forum_posts
