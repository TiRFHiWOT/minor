...
-- Log the changes made (using a simple comment instead of problematic foreign key)
COMMENT ON TABLE ip_geolocation_cache IS 'Emergency fix applied: Cleared false VPN flags from major cloud provider IP ranges to prevent blocking legitimate ad traffic including Google AdSense';