-- Drop and recreate the enriched posts functions to use posts table instead of forum_posts
...
-- Create the get_enriched_posts function to use posts table
...
-- Create the get_enriched_posts_count function to use posts table
